...
public class CCSPITE_16 extends Agent {
	...
	protected void setup() {
		...
		System.out.println("CCSPITE " + name + " is ready.");
	...
	protected void takeDown() {
		...
		System.out.println("CCSPITE " + name + " terminating.");
	}
			...
			if (msg != null) {
				...
				case s2Round:
					...
					if (msg.getPerformative() == ACLMessage.REQUEST /* && msg.getContent().startsWith("Position") */) {
						...
						} //if we are in the first two rounds it is forced to cooperate
