...
public class Pavlov_agent extends Agent {
	...
	private int N, R;
	private String OpLastMove = "C", MyLastMove = "C";
	...
	protected void setup() {
		...
		System.out.println("Pavlov " + name + " is ready.");
	...
	protected void takeDown() {
		...
		System.out.println("Pavlov " + name + " terminating.");
	}
	...
	private class Play extends CyclicBehaviour {
		...
		public String choose() {
			...
			//if we both cooperate or defeat in the last action -> cooperate
			if (MyLastMove.equals("C") && OpLastMove.equals("C") || MyLastMove.equals("D") && OpLastMove.equals("D")) {
				choice ="Action#C";
			} else {
				choice="Action#D"; //if we hadnt take the same action -> defeat
			}
