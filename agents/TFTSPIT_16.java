...
public class TFTSPIT_16 extends Agent {

	private State state;
	private AID mainAgent;
	private int myId, opponentId;
	private int N, R , SPIT = 0 , Defeats = 0;
	...
	protected void setup() {
		...
		System.out.println("TFT_SPIT " + name + " is ready.");
	...
	protected void takeDown() {
		...
		System.out.println("TFT_SPIT " + name + " terminating.");
	}
	...
	private class Play extends CyclicBehaviour {
		...
		public String choose() {
			...
			//is a combination from TFT AND Spiteful
			if(Defeats == 2) { //if there are two consecutivily spiteful mode is activated
				SPIT = 1;
			}

			if (SPIT == 0) { //while spiteful mode is not activated uses TFT
				...
				choice = "Action#" + "D";			} //if spiteful mode is activated always defeat
